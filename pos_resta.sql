...
CREATE DATABASE IF NOT EXISTS `pos_resta` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `pos_resta`;
...
-- Dumping data for table pos_resta.item_penjualan: ~5 rows (approximately)
INSERT INTO `item_penjualan` (`id`, `penjualan_id`, `produk_id`, `kuantitas`, `harga_satuan`, `subtotal`, `created_at`, `updated_at`) VALUES
	...
	(7, 15, 9, 1, 65000, 65000, '2026-09-15 20:16:50', '2026-09-15 20:16:50');
...
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `uang_diterima`, `kembalian`, `status`, `created_at`, `updated_at`) VALUES
	...
	(15, 1, 65000, 'CASH', 100000, 35000, 'COMPLETED', '2026-09-15 20:16:47', '2026-09-15 20:17:05');
...
INSERT INTO `produk` (`id`, `user_id`, `jenis_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `is_active`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(9, 1, 2, 'produk/10zEgQhx592PJ4Hq39yWvB96YCNSi3cgtfuF5Sws.jpg', 'Cardigan Polkadot pink', 40000, 65000, 9, 1, '2026-09-10 23:48:57', '2026-09-15 20:16:50', NULL),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('IjIqi1ADQzvPuAvBP4222uSxWTZRwkbea7Ymw7L8', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789959925),
	('swfL8KQLfREQnazcIbv7A63AnQrUF8aZ0pp8Gacd', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/154.0.0.0 Safari/537.36', '', 1789529338);
