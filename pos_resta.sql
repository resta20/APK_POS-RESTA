...
CREATE DATABASE IF NOT EXISTS `pos_resta` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pos_resta`;
...
-- Dumping data for table pos_resta.item_penjualan: ~0 rows (approximately)
...
-- Dumping data for table pos_resta.migrations: ~1 rows (approximately)
...
-- Dumping data for table pos_resta.penjualan: ~0 rows (approximately)
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `uang_diterima`, `kembalian`, `status`, `created_at`, `updated_at`) VALUES
	...
	(9, 1, 0, 'CASH', NULL, NULL, 'OPEN', '2026-09-10 23:57:15', '2026-09-10 23:57:15');
...
-- Dumping data for table pos_resta.produk: ~0 rows (approximately)
INSERT INTO `produk` (`id`, `user_id`, `jenis_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `is_active`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 1, 1, 'produk/vzKnfPbtydocI3e8xpTp42Qw7eT1lrEciXILNE8h.jpg', 'Celana Begy  Polkadot White', 50000, 75000, 5, 0, '2026-09-10 19:03:30', '2026-09-10 23:50:11', NULL),
	(4, 1, 1, 'produk/dNXmLkb5TiK8w2CVEhVrcFroXVguzJ8VqG7SX6zz.jpg', 'Celana Begy Polkadot Choco', 50000, 75000, 15, 1, '2026-09-10 23:34:56', '2026-09-10 23:49:54', NULL),
	(5, 1, 1, 'produk/s6yXwKMf63DfQQnXG0z1bR0GptqJXvnN0jhiHd71.jpg', 'Celana Begy Polkadot Panda', 50000, 75000, 10, 1, '2026-09-10 23:35:48', '2026-09-10 23:49:35', NULL),
	(6, 1, 1, 'produk/2aW0Z7In34aWiRyG38XrQfbUsLYgR6ZoM8oaEjSn.jpg', 'Celana Begy Bunga', 50000, 75000, 10, 1, '2026-09-10 23:37:55', '2026-09-10 23:37:55', NULL),
	(7, 1, 1, 'produk/JSUBK03tCVWhJTKR0xDCWTEZ7zwyZk3Qs68KEMap.jpg', 'Celana Begy Polkadot Pink', 50000, 75000, 10, 1, '2026-09-10 23:39:32', '2026-09-10 23:39:32', NULL),
	(8, 1, 2, 'produk/qrMh6FzJJHD6Or9ZHgddiwIYJK9m82tZMQHaSLJk.jpg', 'Swetter Love', 40000, 65000, 10, 1, '2026-09-10 23:42:45', '2026-09-10 23:50:36', NULL),
	(9, 1, 2, 'produk/um8FYWZz22CX9NDSwPU82GD6ETE8B27eCKMgKskc.jpg', 'Cardigan Polkadot pink', 40000, 65000, 10, 1, '2026-09-10 23:48:57', '2026-09-10 23:48:57', NULL),
	(10, 1, 2, 'produk/81HeH8FZgmjt0F7o4zlnPd6HvdDW5yB7dagucPIw.jpg', 'Swetter Stripe Pink', 45000, 70000, 10, 1, '2026-09-10 23:53:15', '2026-09-10 23:53:15', NULL),
	(11, 1, 2, 'produk/FbrZtVNSjPaWrbMAEYaI5Su7hfOetU7vpvVvlY9h.jpg', 'Kemeja Putih Rayon Motif', 65000, 85000, 6, 1, '2026-09-10 23:55:01', '2026-09-10 23:55:01', NULL),
	(12, 1, 2, 'produk/qnB0jikip76bQnJo3vhhkYOFey1BDDKIqPIXuBbO.jpg', 'Sweater Pink Bunga', 45000, 68000, 7, 1, '2026-09-10 23:57:02', '2026-09-10 23:57:02', NULL);
...
-- Dumping data for table pos_resta.sessions: ~0 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('RdXpSWsfvhvTw3KG5kNSpIVPN5iljHjX9eW0qrVy', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789109922);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Restadwilestari', 'restadwilestari0@gmail.com', '2026-09-10 19:00:19', '$2y$12$/0RNH5WtyZaHBd1LQKmnvOcSRnU0t9qcGUNS8aJnbQUi60vRjBP/u', 'ZGZBqaE3C8yjt31ryNZcwPdgqs0qqql7ITz8UBXb73SAsasFyAfO5PJ8ekuy', '2026-09-10 19:00:19', '2026-09-10 20:14:09'),
	(2, 2, 'nazwamaulida', 'nazwamaulida@gmail.com', '2026-09-10 19:00:19', '$2y$12$XaY8rxyaxjQBdnvMsQn61OTtZWlcxve9HOjL8xThEnrDLFOqowf5y', 'EjWzmkJUjHumMffg9FtheXoG7isJHJiVDHfQGa3SfR00fAB8bEByj9SvtZyA', '2026-09-10 19:00:19', '2026-09-10 20:14:44'),
